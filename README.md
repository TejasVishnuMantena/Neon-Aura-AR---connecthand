...
* ✨ Neon AR hand tracking
* ⚡ Real-time gesture detection
* 🌌 Cyberpunk visual effects
* 🎵 Interactive audio feedback
* 🔥 Particle physics engine
* 🖐️ Multi-hand tracking
...
Tracks up to 2 hands simultaneously in real-time using MediaPipe.

## ⚡ Gesture Detection

Detects pinch gestures and triggers:
...
Includes multiple futuristic themes:
